...
This is all of the R code for the analyses of papers with 6 authors or less. See Statistical Supplement (SS1.Rmd) for the same analyses applied to the full dataset where only papers with <7 authors are analyzed.
...
gender <- gender %>% filter(TotalAuthors < 7) #subset only papers with <7 authors
